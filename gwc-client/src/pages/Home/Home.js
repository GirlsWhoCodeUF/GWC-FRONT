    ...
    <div className="home">
      <div className="ui inverted vertical masthead center aligned segment hero">
        <div className="ui text container">
          <h1 className="ui inverted header">Girls Who Code @ UF</h1>
          <h2>On a mission to close the gender gap in tech.</h2>
          <button className="ui huge secondary button">
            Learn More <i className="right arrow icon"></i>
          </button>
        </div>
      </div>

      <div className="mission-text">
        <div className="ui stackable relaxed three column grid container">
          <div className="column">
            <LaptopCard
              title="BUILD SISTERHOOD"
              content="Join a community of like-minded women who share a passion for coding and technology. Through Girls Who at UF, you'll have the opportunity to connect with other students who are pursuing careers in tech and build lifelong friendships. By working together, sharing experiences, and supporting each other, you'll be able to create a network of supportive sisters that will be there for you throughout your career."
            />
          </div>
          <div className="column">
            <LaptopCard
              title="BUILD LEADERSHIP"
              content="Girls Who Code at UF empowers women to become leaders in technology. Through our programs and events, you'll gain the skills and knowledge needed to succeed in your career, and you'll have the opportunity to develop your leadership skills. You'll learn how to take charge, collaborate effectively, and inspire others to achieve their goals. Whether you want to lead a team, start your own business, or make a difference in your community, we will provide you with the tools you need to succeed."
            />
          </div>
          <div className="column">
            <LaptopCard
              title="BUILD YOUR CAREER"
              content="Girls Who Code provides you with the resources and support you need to succeed in your career. Through our programs, you'll gain hands-on experience in coding and technology, and you'll have the opportunity to work on real-world projects. You'll learn from experienced professionals in the field, and you'll have access to resources that will help you land your dream job. Whether you want to work for a tech giant, a startup, or a nonprofit, Girls Who Code at UF will help you get there."
            />
          </div>
        </div>
      </div>
...
const LaptopCard = ({ title, content }) => {
  return (
